// classrep.js - Handles Class Representative dashboard logic and security.
        ...
        try {
            ...
            if (userSnap.exists()) {
                ...
                if (role !== expectedRole) {
                    ...
                    const targetPage = (role === 'admin') ? 'admin.html' : (role === 'student' ? 'student.html' : 'index.html');
                ...
                if (userRoleDisplay) {
                    userRoleDisplay.textContent = 'Class Representative'; 
                }
                if (welcomeUserName) {
                    welcomeUserName.textContent = name.split(' ')[0] || 'Class Rep';
                }

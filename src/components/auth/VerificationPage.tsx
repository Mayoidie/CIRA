...
export const VerificationPage: React.FC<VerificationPageProps> = ({ email, onResendVerification, onReturnToLogin }) => {
  return (
        ...
        <div className="text-center">
            ...
            <div className="flex flex-col gap-4">
                <button
                    ...
                    className="w-full bg-[#3942A7] text-white py-3 rounded-lg font-semibold hover:bg-[#2d348a] transition-colors"
                >
